...
CANalystii(vci_device_type,vci_device_ind), node_handle_("~")
{
    ...
    can_msg_pub_ = node_handle_.advertise<can_node_msg::can>(can_msg_pub_topic_, 10);
...
can_node_msg::can CANalystii_node::can_obj2msg(const VCI_CAN_OBJ& can_obj){
...
VCI_CAN_OBJ CANalystii_node::can_msg2obj(const can_node_msg::can& can_msg){
    VCI_CAN_OBJ can_obj;
