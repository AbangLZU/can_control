...
private:
    ...
    //TODO: Noy yet implement subscriber.
...
public:
    ...
    //~CANalystii_node();
    static can_node_msg::can can_obj2msg(const VCI_CAN_OBJ& can_obj);
    static VCI_CAN_OBJ can_msg2obj(const can_node_msg::can& can_msg);
